...
namespace LushCoin
{
	...
	{
		static readonly TransactionSignature _Empty = new TransactionSignature(new ECDSASignature(LushCoin.BouncyCastle.Math.BigInteger.ValueOf(0), LushCoin.BouncyCastle.Math.BigInteger.ValueOf(0)), SigHash.All);
