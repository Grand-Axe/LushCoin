...
namespace LushCoin
{
	...
	public class Network
	{
		...
		{			
			...
			genesis = CreateGenesisBlock(1231006505, 0, 0x1d00ffff, 1, Money.Coins(50m));
		...
		private void InitTest()
		{
			...
			genesis = CreateGenesisBlock(1296688602, 0, 0x1d00ffff, 1, Money.Coins(50m));
			consensus.HashGenesisBlock = genesis.GetHash();
		...
		private void InitReg()
		{
			...
			genesis = CreateGenesisBlock(1296688602, 0, 0x207fffff, 1, Money.Coins(50m));
			consensus.HashGenesisBlock = genesis.GetHash();
			nDefaultPort = 18444;
			nRPCPort = 18332;
			//strDataDir = "regtest";
		...
		private Block CreateGenesisBlock(uint nTime, uint nTally, uint nBits, int nVersion, Money genesisReward)
		{
			...
			return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nTally, nBits, nVersion, genesisReward);
		}

		private Block CreateGenesisBlock(string pszTimestamp, Script genesisOutputScript, uint nTime, uint nTally, uint nBits, int nVersion, Money genesisReward)
		{
		...
		public LushCoin.OpenAsset.BitcoinAssetId CreateAssetId(string base58)
		{
			return new LushCoin.OpenAsset.BitcoinAssetId(base58, this);
		}
