...
namespace LushCoin
{
	...
	public class Network
	{
		...
		private Block CreateGenesisBlock(uint nTime, uint nGizmo, uint nBits, int nVersion, Money genesisReward)
		{
			...
			return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nGizmo, nBits, nVersion, genesisReward);
		}

		private Block CreateGenesisBlock(string pszTimestamp, Script genesisOutputScript, uint nTime, uint nGizmo, uint nBits, int nVersion, Money genesisReward)
		{
