...
namespace LushCoin
{
    ...
    /// <summary>
    /// comment at https://www.codeproject.com/articles/768412/nbitcoin-the-most-complete-bitcoin-port-part-crypt
    /// I renamed it since the time of this article, now it is called PayToPubkeyHashTemplate.

    ///This class will extract the public key hash from the scriptPubKey in the TxOut.
    ///It can also extract the pub key and the signature from the scriptSig of the TxIn.

    ///If you want to create your transaction, I created a very useful class called TransactionBuilder I documented at LushCoin : Build Them All
    /// </summary>
