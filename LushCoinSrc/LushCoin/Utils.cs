...
namespace LushCoin
{
	...
	public class Utils
	{
		...
		internal static Array BigIntegerToBytes(LushCoin.BouncyCastle.Math.BigInteger b, int numBytes)
		{
			if(b == null)
			{
				return null;
		...
		static readonly TraceSource _TraceSource = new TraceSource("LushCoin");
