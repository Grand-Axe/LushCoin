...
using LushCoin.Protocol.Behaviors;
using System;
...
namespace LushCoin.Protocol
{
	...
	public class AddressManager : IBitcoinSerializable
	{
		...
		{
			if(!value)
				throw new InvalidOperationException("Bug in AddressManager, should never happen, contact LushCoin developpers if you see this exception");
		}
