...
using LushCoin.BouncyCastle.Security;
...
namespace LushCoin.Crypto
{
	...
	public static class SCrypt
	{
		...
		{
			return LushCoin.Crypto.SCrypt.ComputeDerivedKey(password, salt, 16384, 8, 8, 8, outputCount);
		}

		public static byte[] BitcoinComputeDerivedKey2(byte[] password, byte[] salt, int outputCount = 64)
		{
			return LushCoin.Crypto.SCrypt.ComputeDerivedKey(password, salt, 1024, 1, 1, 1, outputCount);
		}
